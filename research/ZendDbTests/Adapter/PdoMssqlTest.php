 ...
 * @version    $Id: PdoMssqlTest.php 16086 2009-06-16 05:20:50Z ralph $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Db_Adapter_PdoMssqlTest extends Zend_Db_Adapter_AbstractPdoTestCase
{
    ...
    public function testAdapterDescribeTableAttributeColumn()
    {
        ...
        $this->assertEquals('zf_products',        $desc['product_name']['TABLE_NAME']);
    ...
    public function testAdapterInsertDbExpr()
    {
        ...
        $this->sharedFixture->dbAdapter->query("SET IDENTITY_INSERT $bugs ON");

        $rowsAffected = $this->sharedFixture->dbAdapter->insert('zf_bugs', $row);
        $this->assertEquals(1, $rowsAffected);

        $this->sharedFixture->dbAdapter->query("SET IDENTITY_INSERT $bugs OFF");
    ...
    public function testAdapterTransactionCommit()
    {
        ...
        $this->sharedFixture->dbAdapter->beginTransaction();
        ...
        // commit the DELETE
        $this->sharedFixture->dbAdapter->commit();
    ...
    public function testAdapterTransactionRollback()
    {
        ...
        // rollback the DELETE
        $this->sharedFixture->dbAdapter->rollback();
