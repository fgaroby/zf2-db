 ...
 * @version    $Id: AllTests.php 16086 2009-06-16 05:20:50Z ralph $
 */
...
require_once 'Zend/Db/TestSuite/PdoMysqlTestSuite.php';
...
class Zend_Db_AllTests
{
    ...
    protected static $_suiteNames = array(
//        'Db2',
//        'Mysqli',
//        'Oracle',
//        'PdoIbm',
...
//        'PdoSqlite'
    ...
    public static function main()
    {
        ...
        //PHPUnit_TextUI_TestRunner::run(self::suite(), array('filter' => 'testDbSelectHasTableInstance'));
    }
    ...
    public static function suite()
    {
        ...
        $suite->addTestSuite(new Zend_Db_TestSuite_PdoMysqlTestSuite());
        //$suite->addTestSuite(new Zend_Db_TestSuite('Pdo_Sqlite'));
